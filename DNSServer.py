...
dns_records = {
    ...
    'nyu.edu.': {
        ...
        dns.rdatatype.TXT: (string(encrypted_value),)
    }
        ...
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    qtype.mname, qtype.rname, qtype.serial, qtype.refresh, qtype.retry, qtype.expire, qtype.minimum = answer_data # What is the record format? See dns_records dictionary. Assume we handle @, Class, TTL elsewhere. Do some research on SOA Records
                    rdata = SOA(dns.rdataclass.IN, dns.rdatatype.SOA, qtype.mname, qtype.rname, qtype.serial, qtype.refresh, qtype.retry, qtype.expire, qtype.minimum) # follow format from previous line
